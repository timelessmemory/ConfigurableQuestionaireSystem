...
<!-- <form class="top-div">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="inputUserName" ng-model="user.name" required />
  </div>
  <div class="form-group">
  ...
  <button type="submit" class="btn btn-danger" ng-click="save(user.id)">Save</button>
</form> -->
